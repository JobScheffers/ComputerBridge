...
namespace Bridge.Networking
{
    ...
    public abstract class TableManagerClient : BoardResultOwner
    {
        ...
        {
            this.Connect(_seat, _maxTimePerBoard, _maxTimePerCard, teamName, 18);
        }
    ...
    public class TableManagerClient<TCommunication> : TableManagerClient, IAsyncDisposable where TCommunication : CommunicationDetails
    {
        ...
        public void Connect(Seats _seat, int _maxTimePerBoard, int _maxTimePerCard, string teamName, int protocolVersion, TCommunication _communicationDetails)
        {
            ...
            try
            {
                this.communicationDetails.Connect(this.ProcessIncomingMessage, _seat).Wait();
            }
    ...
    public class TableManagerClientAsync<TCommunication> : BoardResultOwner, IAsyncDisposable where TCommunication : CommunicationDetails
    {
        ...
        private class TMBoardResult<T> : BoardResultEventPublisher where T : CommunicationDetails
        {
            ...
            private TableManagerClientAsync<T> tmc;
